...
make_group(group1_b,
	...
	and_i2rm_b,sub_r2rm_b , xor_i2rm_b, cmp_i2rm_b)

/* 0x81 */
make_group(group1_v,
	add_i2rm_v, or_i2rm_v, adc_i2rm_v, inv, 
	and_i2rm_v, sub_r2rm_v, xor_i2rm_v, cmp_i2rm_v)
...
/* 0x50 */	push_r_v, push_r_v, push_r_v, push_r_v,   /*push + reg*/
...
/* 0x88 */ inv, jne_i_v, inv, inv, 
/* 0x8c */	jl_i_v, inv, inv, jg_i_v, 
